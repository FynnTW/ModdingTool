...
namespace ModdingTool
{
    internal class Unit
    {
        ...
        private int unit_soldierCount = 0;
        private int unit_extrasCount = 0;
        private double unit_mass = 1.0;
        ...
        private int unit_ter_attack = 0;
        private int unit_ter_charge = 0;
        private string unit_ter_projectile = "";
        private int unit_ter_range = 0;
        private int unit_ter_ammunition = 0;
        ...
        private int unit_ter_att_delay = 0;
        private double unit_ter_skel_factor = 0;
